$pf = Get-Content "$env:TEMP\famidash_pf_trace_dorabaebasic7_20260527_032327_474.csv"
$nes = Get-Content "$env:TEMP\famidash_mesen_trace_dorabaebasic7_20260527_033725_021.csv"
$pfHdr = $pf[0] -split ","
$nesHdr = $nes[1] -split ","
