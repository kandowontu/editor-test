...
public class PathfinderSettingsWindow : Window, IComponentConnector
{
	...
	private void OkButton_Click(object sender, RoutedEventArgs e)
	{
		...
		Confirmed = true;
		PreferCoins = ChkPreferCoins.IsChecked.GetValueOrDefault();
		DrawPathLine = ChkDrawPathLine.IsChecked.GetValueOrDefault();
		ShowPathfinderLive = ChkShowLive.IsChecked.GetValueOrDefault();
		ShowProspectivePaths = ChkShowProspective.IsChecked.GetValueOrDefault();
