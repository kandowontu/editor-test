...
$levels = @(
    ...
    "fingerdash","dash","thetower","thechallenge","bestautomaticlvl",
    ...
    "pyrophoric","cryogenic","oceane","generationretro","scarletsurge",
    ...
    "lostinthewoods","rainingtacos","bloodbathbutno","rainbowtylenol","greif",
    "dorabaebasic10","offtomars","akrile","subtleoddities","powertrip",
    "danceofviolins","trolledfix","birdbrain","aprettyeasylevel","tetrix",
    "highlife","extraordinaryexcitement","thelightningroad","nightmare","demonpark",
    ...
    "futurefunkfix","stalemate","eighto","acropolis","hi",
    ...
    "nullscapes","everyend","silentcircles","luckydraw"
)
