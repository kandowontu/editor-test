...
import re, os
T = os.environ['TEMP']
nes = os.path.join(T, 'famidash_mesen_physics_debug_dorabaebasic6_20260526_002323_692.log')
pf_trace = os.path.join(T, 'famidash_pf_trace_FULL_C__famidash_LEVELS_LEVEL_DATA_lvlset_HUGE_dorabaebasic6_tmx_20260526_002317.log')
...
# NES sy raw → linear pixels (skip-F0): high*240 + low
...
HI = int(sys.argv[2]) if len(sys.argv) > 2 else 2200
