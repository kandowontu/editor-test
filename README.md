...
-Manual shifting of sprites - with the move tool, hold shift and drag a sprite to its position it will be shifted to snapped at half tile positions. For more precise control, hold shift+ctrl for pixel perfect shifting. This will generate json data by clicking EXPORT JSON button under set options.
...
--Option to hide color triggers

--Option to hide all other invisible triggers
...
-Right click a tile/sprite on the active layer to copy that tile id to the active tile


-Zoom at fractional levels with pinch/spread or ctrl+mousewheel
